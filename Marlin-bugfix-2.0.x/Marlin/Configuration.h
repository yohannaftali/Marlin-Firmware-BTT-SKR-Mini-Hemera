...
#define STRING_CONFIG_H_AUTHOR "Yohan Naftali" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 - SKR Mini - V2 Hemera"
...
// Hemera extruder motor use 400 steps per unit and need to be calibrated
